...
focus:ring focus:ring-yellow-400 w-full md:px-6 md:py-3"
            type="text"
            name="customer"
            required
          />
...
//here after submitting the form react-router goes to the this below action function and pass the request
...
export async function action({ request }) {
  ...
  // new way to implement error
  const error = {};
  if (!isValidPhone(order.phone))
    error.phone =
      "Please gives us correct phone number.We might need it to contact you.";
